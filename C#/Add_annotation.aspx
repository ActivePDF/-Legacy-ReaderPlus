...
ActivePDF Reader Plus 2019
--%>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_annotation.aspx.cs" Inherits="Add_annotation" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>DocSpace&#x2122; Reader Plus AddAnnotation Sample</title>
        ...
        <script>
            window.onload = function () {
                ...
                readerplus.Document.addEventListener("load", function () {
                    ...
                    // Set at least the minimum annotation properties
                    annotation.type = 5;
                    annotation.X = 100;
                    annotation.Y = 200;
                    ...
                    // Add the rectangle annotation to the first page
