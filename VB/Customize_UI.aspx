...
<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Customize_UI.aspx.vb" Inherits="Customize_UI" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>DocSpace&#x2122; Reader Plus Customize UI Sample</title>
        ...
        <script>
            window.onload = function () {
                ...
                readerplus.Document.addEventListener("load", function () {
                    ...
                    readerplus.mainmenu.Tools.Insert.addItem("Signature", "Signature", "signature_icon.jpg", false, "", "", function () { alert("new menu added"); });
                });
                ...
                $.ajax({
                    type: "POST",
                    url: "Customize_UI.aspx/GetPDFData",
                    data: "{}",
                    dataType: "json",
