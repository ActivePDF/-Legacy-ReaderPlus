...
<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Basic_implementation.aspx.vb" Inherits="Basic_implementation" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>DocSpace&#x2122; Reader Plus Basic Sample</title>
        ...
        <script>
            window.onload = function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Basic_Implementation.aspx/GetPDFData",
                    data: "{}",
                    dataType: "json",
