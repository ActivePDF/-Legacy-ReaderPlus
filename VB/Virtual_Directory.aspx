...
<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Virtual_Directory.aspx.vb" Inherits="Virtual_Directory" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>DocSpace&#x2122; Reader Plus Virtual Directory Sample</title>
        ...
        <script>
            window.onload = function () {
                ...
                // Open document from a virtual directory
                // Virtual directory settings are in RPSettings.xml
                var result = readerplus.Document.open("Documents/ReaderPlusSample.pdf");
                if (result.Status === 0) {
                    ...
                    // Open document
                    readerplus.Document.view(docID);
                }
                else {
                    // Display alert on error
